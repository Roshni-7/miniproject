...
session_start();
//$command1 = escapeshellcmd('C:\xampp\htdocs\pro\testapp.py');
//$command2 = escapeshellcmd('C:\xampp\htdocs\pro\testmodel.py');
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;"> Career Recomendation System</h1>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to TREMPLIN</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">TREMPLIN</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
